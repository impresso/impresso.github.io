---
title: 'Call for papers: Beyond Borders. Futures of Digitised Historical Media Collections for Research and Teaching'
status: published
category: news
seealso:
  - /project/objectives/
...
One way to bridge this gap is the principle of scalable reading (shifting between close and distant reading) that has become a near-commonplace for homogeneous collections (books, newspapers, etc) but not yet for collections consisting of different modalities (e.g. text, audio, image). 
...
[Submit through EasyChair](https://easychair.org/my/conference?conf=bb2026).
...
{% raw %}
<div id="submit-paper">
  <button type="button" onclick="window.open('https://easychair.org/my/conference?conf=bb2026', '_blank', 'noopener,noreferrer');">
